...
import benchmark.common.generator.AdGenerator;
import benchmark.common.generator.RedisHelper;
...
public class AdvertisingTopologyLocalGenerator {
    ...
    public static class LocalGeneratorSpout extends BaseRichSpout{

        private SpoutOutputCollector _collector;
        private AdGenerator _generator;

        public LocalGeneratorSpout(AdGenerator generator){
        ...
        public void nextTuple(){
            _collector.emit(new Values(_generator.generateElement()), UUID.randomUUID());

        }

        public void declareOutputFields(OutputFieldsDeclarer declarer) {
            declarer.declare(new Fields("ad_event"));
        }
    }
    ...
    public static class CampaignProcessor extends BaseRichBolt {
        ...
        private static final Logger LOG = Logger.getLogger(AdvertisingTopology.CampaignProcessor.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        RedisHelper redis = new RedisHelper(redisServerHost,0, true);
        redis.prepareRedis(generator.getCampaigns());

        //KafkaSpout kafkaSpout = new KafkaSpout(spoutConfig);
        builder.setSpout("ads", new LocalGeneratorSpout(generator), parallel);
